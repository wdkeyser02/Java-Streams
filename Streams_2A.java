...
public class Streams_2A {
    public static void main(String[] args) {
        ...
        Map<Object, List<String>> members = people.stream()
            .collect(Collectors.groupingBy(Person::firstName, Collectors.mapping(Person::firstName, Collectors.toList())));
        members.forEach((k , v) -> System.out.println(k + ": " + v));
        System.out.println();

        members = people.stream()
            .collect(Collectors.groupingBy(Person::firstName, Collectors.mapping(Person::lastName, Collectors.toList())));
        members.forEach((k , v) -> System.out.println(k + ": " + v));
    }
