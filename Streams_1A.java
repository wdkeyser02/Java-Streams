...
public class Streams_1A {
    public static void main(String[] args) {
        ...
        Map<Boolean, Set<Person>> members = people.stream()
            .collect(Collectors.partitioningBy(person -> person.age > 27, Collectors.toSet()));
        members.forEach((k , v) -> System.out.println(k + ": " + v + "\n"));
        System.out.println();

        members = people.stream()
            .collect(Collectors.partitioningBy(person -> person.firstName.equals("David"), Collectors.toSet()));
        members.forEach((k , v) -> System.out.println(k + ": " + v + "\n"));
    }
